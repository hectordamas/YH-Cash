                ...
                <div class="card-body">
                    <form action="{{ route('expenses.update', ['expense' => $expense->id]) }}" method="post" class="row">
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <input type="date" name="fecha" id="fecha" class="form-control" value="{{ $expense->fecha }}" required>
                        </div>
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <input type="text" name="numero" id="numero" class="form-control" required value="{{$expense->numero}}">
                        </div>

                        <div class="col-md-3 form-group">
                            <label for="" class="font-weight-bold">Monto:</label>
                            <input type="number" name="monto" id="monto" class="form-control" required step="any" value="{{$expense->monto}}">
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <input type="text" name="concepto" id="concepto" required class="form-control" value="{{$expense->concepto}}">
                        </div>

                        <div class="col-md-3 form-group">
                            <label for="" class="font-weight-bold">Descripción:</label>
                            <input type="text" name="descripcion" id="descripcion" required class="form-control" value="{{$expense->descripcion}}">
                        </div>
